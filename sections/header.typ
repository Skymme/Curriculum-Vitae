  ...
  place(top + left, dx: -15mm, dy: -3mm)[
    #block(
      ...
      #grid(
        ...
        align(top + left)[
          #v(-5pt)
          #text(size: 21pt, weight: "bold", fill: color-white)[#personal.name]
          #v(-9pt)
          #text(size: 11pt, fill: color-white, style: "italic")[#personal.title]
          #v(-1pt)
          ...
          #par(leading: 0.58em, text(size: 8.6pt, fill: color-white)[#personal.summary])
          #v(1pt)
          #stack(
            dir: ltr,
            spacing: 6pt,
        ...
        align(top + left)[
          ...
          #stack(
            place(dx: 0pt, dy: 0pt)[
              #line(angle: 90deg, length: 92pt, stroke: 0.5pt + color-white)
            ],
            box(inset: (left: 15pt), width: 118pt)[
              #set text(fill: color-white, size: 8.4pt)
              ...
              #personal.phone \
              #v(1pt)
              #text(weight: "bold")[#t.availability] \
